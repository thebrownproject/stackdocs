-- ============================================================================
-- Migration: Stacks Schema + Agent SDK Sessions
-- Date: 2024-12-18
...
-- Which model/SDK produced this extraction
ALTER TABLE extractions
...
COMMENT ON COLUMN extractions.model IS 'Model used: claude-haiku-4-5, claude-agent-sdk, etc.';
...
-- NOTE: Helper functions removed - Supabase client handles queries directly.
-- Agent tools fetch data via API, not SQL functions.
